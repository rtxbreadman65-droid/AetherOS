...
on mine. To run my operating system please use my bootloader only which is in src folder, and my compilations command. If you need any help here is my instagram id: sys.arshman.
