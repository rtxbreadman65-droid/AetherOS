...
put main.rs in src folder. unzip AetherOS_efi.zip. This is my 2 months project not that much advanced bruh but you can try my OS if you love bare-metal and runtime jit. this is only for uefi. Inspired my Terry Davis. use my Cargo.toml and Cargo.lock.
